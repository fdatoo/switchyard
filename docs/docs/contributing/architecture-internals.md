...
This page is a deep reference for contributors working on the switchyard daemon. It explains module boundaries, concurrency invariants, and the two most complex subsystems (the Carport FSM and config diff-based reload). Each section points to the relevant child design spec for further reading.
...
| `internal/automation` | Automation engine. One Starlark VM per trigger; sandboxed execution with switchyard built-ins. |
...
| `spawning` | `switchyardd` is launching the driver binary as a subprocess. |
...
Each transition appends an event to the event log. The registry projector consumes these events to maintain the visible driver-instance status that `switchyard status` and the web UI display.

Design spec: [C2 — Carport Protocol Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-21-c2-carport-protocol-design.md)
...
Design spec: [C4 — Pkl Config Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-22-c4-pkl-config-design.md)
...
| Subsystem | Spec |
|-----------|------|
| Event store | [C1 — Event Core and Storage Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-21-c1-event-core-and-storage-design.md) |
| Carport protocol | [C2 — Carport Protocol Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-21-c2-carport-protocol-design.md) |
| Driver SDK | [C3 — Driver SDK Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-22-c3-driver-sdk-design.md) |
| Pkl config | [C4 — Pkl Config Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-22-c4-pkl-config-design.md) |
| Starlark runtime | [C5 — Starlark Runtime Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-22-c5-starlark-runtime-design.md) |
| Automation engine | [C6 — Automation Engine Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-23-c6-automation-engine-design.md) |
| Connect-RPC API | [C7 — Connect-RPC API Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-23-c7-connect-rpc-api-design.md) |
| MCP server | [C8 — MCP Server Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-24-c8-mcp-server-design.md) |
| Auth & Policy | [C9 — Auth and Policy Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-25-c9-auth-and-policy-design.md) |
| Web UI | [C10 — Web UI Architecture Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-26-c10-web-ui-architecture-design.md) |
| HA Import Tool | [C11 — HA Import Tool Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-26-c11-ha-import-tool-design.md) |
| Edge Agent | [C12 — Edge Agent Design](https://github.com/fynn-labs/switchyard-docs/blob/main/superpowers/specs/2026-04-27-c12-edge-agent-design.md) |
