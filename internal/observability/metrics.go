...
func NewMetrics() *Metrics {
	...
	m.AutomationTriggersTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_automation_triggers_total", Help: "Automation trigger fires admitted to execution"},
		[]string{"automation_id", "trigger_kind"},
	)
	m.AutomationRunsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_automation_runs_total", Help: "Automation run completions by outcome"},
		[]string{"automation_id", "outcome"},
	)
	m.AutomationConditionsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_automation_conditions_total", Help: "Automation condition evaluations by result"},
		[]string{"automation_id", "result"},
	)
	m.AutomationActionsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_automation_actions_total", Help: "Automation action executions by kind and result"},
		[]string{"automation_id", "action_kind", "result"},
	)
	m.AutomationReloadFailuresTotal = prometheus.NewCounter(prometheus.CounterOpts{
		Name: "gohome_automation_reload_failures_total", Help: "Automation config reload compile failures",
	})
	m.ScriptInvocationsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_script_invocations_total", Help: "Script invocations by outcome and invoker kind"},
		[]string{"script_name", "outcome", "invoked_by_kind"},
	)

	m.AutomationRunDurationSeconds = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{Name: "gohome_automation_run_duration_seconds", Help: "Automation run wall-clock duration", Buckets: prometheus.DefBuckets},
		[]string{"automation_id"},
	)
	m.AutomationStarlarkSteps = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "gohome_automation_starlark_steps",
	...
	m.ScriptDurationSeconds = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{Name: "gohome_script_duration_seconds", Help: "Script execution wall-clock duration", Buckets: prometheus.DefBuckets},
		[]string{"script_name"},
	)

	m.AutomationInflight = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{Name: "gohome_automation_inflight", Help: "Automation runs currently in flight"},
		[]string{"automation_id"},
	)
	m.AutomationRegistered = prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "gohome_automation_registered", Help: "Number of registered automations",
	})
	m.ScriptRegistered = prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "gohome_script_registered", Help: "Number of registered scripts",
	})

	m.APIRequestsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_api_requests_total", Help: "Completed API RPCs by procedure and code."},
	...
	m.APIStreamEventsSentTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_api_stream_events_sent_total", Help: "Streamed payload events sent."},
		[]string{"procedure"},
	)
	m.APIStreamHeartbeatsSentTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_api_stream_heartbeats_sent_total", Help: "Heartbeats sent on streaming RPCs."},
		[]string{"procedure"},
	)
	m.APIStreamBackpressureClosesTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_api_stream_backpressure_closes_total", Help: "Streaming RPCs closed with RESOURCE_EXHAUSTED."},
		[]string{"procedure"},
	)
	m.APIWebhookReceivedTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_api_webhook_received_total", Help: "Webhook outcomes by slug and result."},
		[]string{"slug", "result"},
	)
	m.APIActiveStreams = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{Name: "gohome_api_active_streams", Help: "Currently-open server streams."},
		[]string{"procedure"},
	)

	m.MCPToolCallsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_mcp_tool_calls_total", Help: "Total MCP tool dispatches by tool and outcome."},
		[]string{"tool", "result"},
	)
	m.MCPToolCallDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{Name: "gohome_mcp_tool_call_duration_seconds", Help: "Latency of MCP tool dispatches.", Buckets: prometheus.DefBuckets},
		[]string{"tool", "result"},
	)
	m.MCPResourceSubscriptionsActive = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{Name: "gohome_mcp_resource_subscriptions_active", Help: "Currently-open MCP resource subscriptions."},
		[]string{"kind"},
	)
	m.MCPResourceUpdatesSent = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_mcp_resource_updates_sent_total", Help: "MCP notifications/resources/updated fired."},
		[]string{"kind"},
	)
	m.MCPResourceOverflowCloses = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_mcp_resource_overflow_closes_total", Help: "MCP subscriptions affected by buffer overflow."},
		[]string{"kind", "reason"},
	)
	m.MCPEvalStarlarkTruncated = prometheus.NewCounter(prometheus.CounterOpts{
		Name: "gohome_mcp_eval_starlark_truncated_total", Help: "eval_starlark calls whose output exceeded the cap.",
	})
	m.MCPConfigFileWrites = prometheus.NewCounterVec(
		prometheus.CounterOpts{Name: "gohome_mcp_config_file_writes_total", Help: "Filesystem-tool writes by extension and outcome."},
	...
	m.PolicyAuthorizeDurationSeconds = prometheus.NewHistogram(prometheus.HistogramOpts{
		Name:    "gohome_policy_authorize_duration_seconds",
